...
import Admadminssion from "./Components/Admadminssion"
import AdminPayment from "./Components/AdminPayment"
import Admadcourse from "./Components/Admadcourse";
...
// import Card from "./Components/Card"
 const App = () => {
  ...
  <Routes>
    ...
    <Route path='/Admadcourse' element={<Admadcourse/>}></Route>
    <Route path='/AdminViewEnquiry' element={<AdminViewEnquiry/>}></Route>
    <Route path='/AdminPayment' element={<AdminPayment/>}></Route>
    <Route path='/Admadminssion' element={<Admadminssion/>}></Route>
    </Routes>
    </BrowserRouter> 
